  ...
  def reussi(taille, difficulte)
    ...
    if(difficulte == 0)
      ...
      if(taille == 7)
        ...
        add(Gtk::Image.new(:file => "lib/Hashi/Data/Pont Gaulois.jpg"))
      ...
      if(taille == 7)
        ...
        add(Gtk::Image.new(:file => "lib/Hashi/Data/Zubi Zuri.jpg"))
      ...
      if(taille == 7)
        ...
        add(Gtk::Image.new(:file => "lib/Hashi/Data/Golden Bridge.jpg"))
